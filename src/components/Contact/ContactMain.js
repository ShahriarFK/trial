      ...
      <CardGroup>
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              <h3 className="card-des">20/4 Jhon Carrel Street, Sydney</h3>
            </Card.Text>
          </Card.Body>
          <Card.Footer>
        ...
        <Card>
          ...
          <Card.Body>
            <Card.Title><h1 className="card-title">Mail Us
            </h1>
            </Card.Title>
            <Card.Text>
              <h5 className="card-des">drivega.sydney@gmail.com</h5>
            </Card.Text>
          </Card.Body>
          <Card.Footer>
